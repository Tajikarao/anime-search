...
def sndx(anime_list, search, limit):
    ...
    soundex_list = [soundex.soundex(anime) for anime in anime_list]
    search_soundex = soundex.soundex(search)
    ...
    tfidf = vectorizer.fit_transform([anime_list[i] for i in soundex_indices])
